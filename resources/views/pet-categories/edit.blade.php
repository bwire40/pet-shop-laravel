<x-app-layout>
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="max-w-7xl h-screen flex-grow p-6">
            <form class="p-4 md:p-5" action="{{ route('pet-categories.update', $pet_category->id) }}" method="post">
                @csrf
                @method('put')
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name" id="name" value="{{ $pet_category->name }}"
