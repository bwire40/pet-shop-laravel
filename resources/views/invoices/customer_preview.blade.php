    ...
    <div class="bg-white rounded-lg shadow-lg px-8 py-10 max-w-3xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="text-gray-700">
                <div class="font-bold text-2xl mb-2 text-center">APPLICATION DETAILS</div>
                <div class="text-md font-bold">Date: <span class="text-sm text-slate-500">
                        {{ $adorption->created_at }}</span></div>
                <div class="text-md font-bold">ORDER NO: <span
        ...
        <div class="border-t-2 border-gray-300 pt-8 mb-8">
            <div class="text-gray-700 mb-2">Your application has been approved and is ready for collection</div>
            ...
            <h1 class="text-gray-800 mb-2 py-2 font-bold">Kindly Visit the Shop to finilize on payments and pick up your
                pet.
            </h1>
        </div>
    </div>
