    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-4xl lg:py-16">
                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add a new Accessory</h2>
                <form class="mt-4" action="{{ route('accessories.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div>
                            <label for="price"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price (Kshs)
                            </label>
                            <input type="number" name="price" id="price" min="0"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Kshs 300">
                        </div>
                        @error('price')
                            <p class="text-red-500 text-sm">{{ $message }}</p>
                        @enderror
