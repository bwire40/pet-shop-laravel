<x-app-layout>
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        ...
        <main class="w-full flex-grow p-6">
            {{-- view categories --}}
            <h1 class="text-xl font-bold">Manage accessories</h1>
            <div class="p-3">
                        ...
                        <tbody>
                            ...
                            @foreach ($accessories as $accessory)
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <img src="{{ asset('images/' . $accessory->image) }}" class="w-20 h-20"
                                            alt="">
                                        {{-- {{ $accessory->image }} --}}
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <form action="{{ secure_url(route('accessories.destroy', $accessory->id)) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
