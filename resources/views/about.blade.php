    ...
    <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        ...
        <div class="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
            <div class="w-full lg:w-6/12">
                <h2 class="w-full font-bold lg:text-4xl text-3xl lg:leading-10 dark:text-white leading-9">We are here to give
                    homes to nature's best</h2>
                <p class="font-normal text-base leading-6 text-gray-600 dark:text-gray-200 mt-6">Welcome to PetShop, where we
                    believe in creating lasting bonds between pets and their loving owners. At PetShop, we go beyond being a
                    mere pet store – we are your trusted partner in the journey of pet parenthood.</p>
            </div>
            <div class="w-full lg:w-6/12">
                <img class="lg:block hidden w-full" src="https://rb.gy/2ryrgu" alt="people discussing on board" />
                <img class="lg:hidden sm:block hidden w-full" src="https://rb.gy/2ryrgu" alt="people discussing on board" />
                <img class="sm:hidden block w-full" src="https://rb.gy/2ryrgu" alt="people discussing on board" />
            </div>
        </div>
        ...
        <div class="relative mt-24">
            <div class="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                ...
                <img class="z-20" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/about-us-3-svg2.svg"
                    alt="note" />
        ...
        <div class="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
            <div class="w-full lg:w-6/12">
                <h2 class="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 dark:text-white">Our Mission
                </h2>
                <p
                    class="font-normal text-base leading-6 text-gray-600 dark:text-gray-200 mt-6 w-full lg:w-10/12 xl:w-9/12">
                </p>
                <p
                    class="font-normal text-base leading-6 text-gray-600 dark:text-gray-200 w-full lg:w-10/12 xl:w-9/12 mt-10">
                    At PetShop, our mission is grounded in the belief that every pet deserves a loving home and every home
                    deserves the joy of a furry companion. We strive to be more than just a pet store; we are advocates for
                    the well-being of animals and partners in building lasting connections between pets and their human
                    families.</p>
            </div>
            <div class="w-full lg:w-6/12">
